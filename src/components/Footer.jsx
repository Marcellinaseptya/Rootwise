...
export default function Footer() {
  ...
  return (
    <>
      {/* Call to Action Section (Hidden on Homepage) */}
      {!isHomepage && (
        <motion.div 
          initial="hidden"
          whileInView="visible"
          ...
          className="relative w-full" style={{ minHeight: '600px' }}
        >
          <img 
            src={calculatorImg} 
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            ...
            {/* Top Row */}
            <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="absolute top-16 left-0 right-0 hidden md:flex justify-between items-center" style={{ padding: '0 10%' }}>
            ...
            <motion.h2 variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="font-['Geist'] text-white font-normal" style={{ fontSize: '56px', lineHeight: '1.1', marginBottom: '40px', maxWidth: '800px', letterSpacing: '-0.02em' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-12 xl:px-24">
        ...
        <motion.div 
          ...
          className="flex flex-col lg:flex-row justify-between mb-12 gap-16 lg:gap-12"
        >
          
          {/* Logo and Socials */}
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="flex flex-col gap-10">
            {/* Logo */}
            ...
            <div className="flex items-center gap-4">
              <motion.a whileHover={{ scale: 1.1, backgroundColor: "#1f2937" }} href="#" className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center transition-colors text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-16">
            {/* Column 1 */}
            <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="flex flex-col gap-6">
        ...
        <motion.div 
          ...
          className="w-full h-[1px] bg-gray-800 mb-5"
        ></motion.div>
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row justify-between items-center gap-4 text-[14px] font-medium font-['Manrope'] text-gray-400 mb-6"
        >
