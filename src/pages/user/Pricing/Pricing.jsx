  ...
  return (
    <>
      ...
      <motion.div 
        ...
        className="max-w-7xl mx-auto px-4 lg:px-12 xl:px-24 flex flex-col items-center relative z-10"
      >
        
        {/* Header Badge */}
        <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="flex items-center gap-2 mb-6">
        ...
        {/* Title */}
        <motion.h1 variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="text-[44px] md:text-[56px] lg:text-[72px] font-normal font-['Geist'] text-black text-center leading-[1.05] tracking-tight mb-6">
        ...
        {/* Subtitle */}
        <motion.p variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="text-[15px] md:text-[17px] font-medium font-['Manrope'] text-gray-600 text-center max-w-2xl mb-12 tracking-wide">
          ROOTWISE illustrates how products cater to the needs of farmers globally,
        </motion.p>

        {/* Toggle */}
        <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="flex items-center p-[5px] rounded-full border border-gray-200 bg-white mb-20 w-[360px] max-w-full justify-between shadow-sm">
          <button 
        ...
        >
          ...
          {/* Basic Plan */}
          <motion.div variants={{ hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="bg-[#F8F9FA] rounded-[32px] p-8 lg:p-10 flex flex-col hover:-translate-y-2 transition-transform duration-300">
          ...
          {/* Pro Plan */}
          <motion.div variants={{ hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 70, damping: 18 } } }} className="bg-[#165514] rounded-[32px] p-8 lg:p-10 flex flex-col relative transform lg:-translate-y-4 shadow-2xl hover:lg:-translate-y-6 transition-transform duration-300">
